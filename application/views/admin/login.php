...
<html lang="en">
  <head>
    ...
    <title>Praias Construtora - Administrador </title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            ...
            name='frmLoginAdmin' id='frmLoginAdmin'>
              <h1><img src="<?=site_url('img/praias.png');?>" alt="Praia Atlantica logo"></h1>
              <div>
              ...
              <div class="clearfix"></div>
                  <p>© <?=date('Y');?> All Rights Reserved - Praia Construtora</p>
                </div>
              </div>
            </form>
          </section>
